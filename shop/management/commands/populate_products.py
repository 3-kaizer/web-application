    ...
    def handle(self, *args, **kwargs):
        ...
        products_data = [
            ...
            },
            {
                'name': 'Pulse Rhythm',
                'category': 'Over-Ear',
                'description': 'Studio monitoring headphones tuned for a balanced, precise soundstage. Pulse Rhythm provides accurate mixing clarity with durable memory foam cups and refined noise isolation for long producing sessions.',
            ...
            },
            {
                'name': 'Echo Studio',
                'category': 'Over-Ear',
                'description': 'High-resolution audiophile headphones engineered for immersive listening. Echo Studio delivers crisp highs, rich mids, and powerful lows with a luxurious fit and studio-grade sound reproduction.',
            ...
            },
            {
                'name': 'Bass Pro Zero',
                'category': 'In-Ear',
                'description': 'Professional monitor earbuds built for punchy low end and crystalline detail. Bass Pro Zero offers a secure fit, rich bass response, and studio-ready transparency for performing artists and producers.',
            ...
            },
            {
                'name': 'Zen Air Lite',
                'category': 'Wireless',
                'description': 'Lightweight everyday wireless headphones with effortless comfort and responsive sound. Zen Air Lite blends long battery life with a soft, breathable fit for all-day listening in motion.',
